...
{
    const allOperations = args.filter(x => typeof x === "string");
    const allNumbers = args.filter(x => typeof x === "number");
    ...
    if (allOperations.length > 1)
        { errors.push("คุณใส่เครื่องหมายคำนวณมากเกิน กรุณาใส่ใหม่"); }
    if (allNumbers.length === 0)
        { errors.push("คุณลืมใส่ตัวเลข"); }
    if (allNumbers.length < 2 && allNumbers.length > 0)
        { errors.push("คุณใส่ตัวเลขไม่ครบ กรุณาใส่ใหม่"); }
    if (allNumbers.length > 2)
        { errors.push("คุณใส่ตัวเลขมากเกิน กรุณาใส่ใหม่"); }
    ...
    switch (operation) {
        ...
        default: return "คุณใส่เครื่องหมายคำนวณไม่ถูกต้อง กรุณาใส่ใหม่";
    }
}
...
console.log(calculator(10, 5, "+", "*"));
console.log(calculator(10, 5, "*"));
console.log(calculator("บวก", 10, 5));
console.log(calculator("บวก", 20, 5,10,"times"));